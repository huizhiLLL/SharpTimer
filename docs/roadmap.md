...
- 支持少量本地设置：是否启用观察、显示精度、亮/暗主题、背景材质、中英文界面语言；默认英文、亮色、Mica、百分秒。
...
- 主计时区右下角展示智能魔方 3D 状态本体；当前使用 WinUI 原生 Canvas 参考 DCTimer 智能魔方状态图渲染真实感更强的贴纸投影；Ao5/Ao12 统计块缩窄，为右下角状态图保留空间。
